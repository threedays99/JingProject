...
public class PhoneVerify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Phonenumber = getIntent().getStringExtra("telephonenumber");
        ...
        new CountDownTimer(60000,1000){
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Btnresend.setTextColor(ContextCompat.getColor(PhoneVerify.this,android.R.color.black));
...
//          倒计时结束调用
            ...
            public void onClick(View view) {
                ...
                new CountDownTimer(60000,1000){
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        Btnresend.setTextColor(ContextCompat.getColor(PhoneVerify.this, R.color.Black));
                        Btnresend.setTextSize(16);
    ...
    private void Registerverifycode(String smscode) {
        ...
        RegisterWithPhoneCredential(credential);
    }

    private void RegisterWithPhoneCredential(PhoneAuthCredential credential) {
        Firebaseauth.getCurrentUser().linkWithCredential(credential).addOnCompleteListener(PhoneVerify.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {

                if(task.isSuccessful()){
                    Intent intent = new Intent(PhoneVerify.this, MainPage.class);
                    startActivity(intent);
                    finish();
                }else{
                    AlertDialog.Builder builder_alert = new AlertDialog.Builder(PhoneVerify.this);
